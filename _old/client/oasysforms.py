...
class frmOasys(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=_("Oasys"), pos=wx.DefaultPosition, size=wx.Size(-1, -1),
        ...
        self.menuLoadPreferences = wx.MenuItem(self.menuFile, wx.ID_ANY, _("Load preferences..."), wx.EmptyString,
                                               wx.ITEM_NORMAL)
        self.menuFile.AppendItem(self.menuLoadPreferences)

        self.menuSavePreferences = wx.MenuItem(self.menuFile, wx.ID_ANY, _("Save preferences..."), wx.EmptyString,
                                               wx.ITEM_NORMAL)
        self.menuFile.AppendItem(self.menuSavePreferences)

        self.menuFile.AppendSeparator()

        self.menuFileNewConnection = wx.MenuItem(self.menuFile, wx.ID_ANY, _("Start Connection..."), wx.EmptyString,
                                                 wx.ITEM_NORMAL)
        self.menuFile.AppendItem(self.menuFileNewConnection)

        self.menuFileManageConnections = wx.MenuItem(self.menuFile, wx.ID_ANY, _("Manage Connections..."),
        ...
        self.menuDirectoryIndividuals = wx.MenuItem(self.menuDirectory, wx.ID_ANY, _("Individuals..."), wx.EmptyString,
                                                    wx.ITEM_NORMAL)
        self.menuDirectory.AppendItem(self.menuDirectoryIndividuals)

        self.menuDirectoryCompanies = wx.MenuItem(self.menuDirectory, wx.ID_ANY, _("Companies..."), wx.EmptyString,
                                                  wx.ITEM_NORMAL)
        ...
        self.menuToolsImport = wx.MenuItem(self.menuTools, wx.ID_ANY, _("Import accounts..."), wx.EmptyString,
                                           wx.ITEM_NORMAL)
        self.menuTools.AppendItem(self.menuToolsImport)

        self.menuToolsExport = wx.MenuItem(self.menuTools, wx.ID_ANY, _("Export accounts..."), wx.EmptyString,
                                           wx.ITEM_NORMAL)
        self.menuTools.AppendItem(self.menuToolsExport)

        self.menuTools.AppendSeparator()

        self.menuToolsImportEntries = wx.MenuItem(self.menuTools, wx.ID_ANY, _("Import journal entries..."),
                                                  wx.EmptyString, wx.ITEM_NORMAL)
        self.menuTools.AppendItem(self.menuToolsImportEntries)

        self.menuToolsExportEntries = wx.MenuItem(self.menuTools, wx.ID_ANY, _("Export journal entries..."),
                                                  wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.lblDispDataComp = wx.StaticText(self, wx.ID_ANY, _("Displaying data for company"), wx.DefaultPosition,
                                             wx.DefaultSize, 0)
        ...
        self.m_staticText24 = wx.StaticText(self, wx.ID_ANY, _("Accounting period"), wx.DefaultPosition, wx.DefaultSize,
                                            0)
        ...
        self.textProfileCode = wx.TextCtrl(self.pnProfile, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        ...
        self.textProfileName = wx.TextCtrl(self.pnProfile, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                           wx.Size(200, -1), 0)
        fgSizer5.Add(self.textProfileName, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        fgSizer7.Add(fgSizer5, 1, wx.EXPAND, 5)

        self.m_staticText10 = wx.StaticText(self.pnProfile, wx.ID_ANY, _("Description:"), wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        self.m_staticText10.Wrap(-1)
        fgSizer7.Add(self.m_staticText10, 0, wx.ALL, 5)

        self.textProfileDescription = wx.TextCtrl(self.pnProfile, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition,
                                                  wx.Size(-1, -1), wx.HSCROLL | wx.TE_MULTILINE)
        ...
        self.pnChartOfAccounts = wx.Panel(self.nbCompany, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                          wx.TAB_TRAVERSAL)
        ...
        self.m_splitter1 = wx.SplitterWindow(self.pnChartOfAccounts, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                             wx.SP_3D | wx.SP_3DSASH | wx.SP_LIVE_UPDATE)
        ...
        self.m_splitter2 = wx.SplitterWindow(self.m_panel18, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                             wx.SP_3D | wx.SP_3DSASH | wx.SP_LIVE_UPDATE)
        ...
        self.m_staticText15 = wx.StaticText(self.m_panel19, wx.ID_ANY, _("Assets"), wx.DefaultPosition, wx.DefaultSize,
                                            0)
        self.m_staticText15.Wrap(-1)
        fgSizer17.Add(self.m_staticText15, 0, wx.ALL, 5)

        self.treeAssets = wx.TreeCtrl(self.m_panel19, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
        ...
        self.menuAccountMoveUp = wx.MenuItem(self.menuAssets, wx.ID_ANY, _("Move up one level"), wx.EmptyString,
                                             wx.ITEM_NORMAL)
        self.menuAssets.AppendItem(self.menuAccountMoveUp)

        self.menuAccountMoveDown = wx.MenuItem(self.menuAssets, wx.ID_ANY, _("Move down one level..."), wx.EmptyString,
                                               wx.ITEM_NORMAL)
        self.menuAssets.AppendItem(self.menuAccountMoveDown)

        self.menuAssets.AppendSeparator()

        self.menuAccountShowEntries = wx.MenuItem(self.menuAssets, wx.ID_ANY, _("Show journal entries"), wx.EmptyString,
                                                  wx.ITEM_NORMAL)
        self.menuAssets.AppendItem(self.menuAccountShowEntries)

        self.menuAccountInsertEntry = wx.MenuItem(self.menuAssets, wx.ID_ANY, _("Insert journal entry..."),
                                                  wx.EmptyString, wx.ITEM_NORMAL)
        ...
        self.m_staticText16 = wx.StaticText(self.m_panel20, wx.ID_ANY, _("Liabilities"), wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        self.m_staticText16.Wrap(-1)
        fgSizer18.Add(self.m_staticText16, 0, wx.ALL, 5)

        self.treeLiabilities = wx.TreeCtrl(self.m_panel20, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                           wx.TR_DEFAULT_STYLE | wx.TR_HIDE_ROOT)
        ...
        self.m_splitter21 = wx.SplitterWindow(self.m_panel21, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                              wx.SP_3D | wx.SP_3DSASH | wx.SP_LIVE_UPDATE)
        ...
        self.m_staticText17 = wx.StaticText(self.m_panel191, wx.ID_ANY, _("Income Accounts"), wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        self.m_staticText17.Wrap(-1)
        fgSizer171.Add(self.m_staticText17, 0, wx.ALL, 5)

        self.treeIncomeAccounts = wx.TreeCtrl(self.m_panel191, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                              wx.TR_DEFAULT_STYLE | wx.TR_HIDE_ROOT)
        ...
        self.m_staticText18 = wx.StaticText(self.m_panel201, wx.ID_ANY, _("Expense Accounts"), wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        self.m_staticText18.Wrap(-1)
        fgSizer181.Add(self.m_staticText18, 0, wx.ALL, 5)

        self.treeExpenseAccounts = wx.TreeCtrl(self.m_panel201, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                               wx.TR_DEFAULT_STYLE | wx.TR_HIDE_ROOT)
        ...
        self.m_checkBox3 = wx.CheckBox(self.pnChartOfAccounts, wx.ID_ANY, _("Assets"), wx.DefaultPosition,
                                       wx.DefaultSize, 0)
        gSizer3.Add(self.m_checkBox3, 0, wx.ALL, 5)

        self.m_checkBox4 = wx.CheckBox(self.pnChartOfAccounts, wx.ID_ANY, _("Liabilities"), wx.DefaultPosition,
                                       wx.DefaultSize, 0)
        gSizer3.Add(self.m_checkBox4, 0, wx.ALL, 5)

        self.m_checkBox5 = wx.CheckBox(self.pnChartOfAccounts, wx.ID_ANY, _("Income Accounts"), wx.DefaultPosition,
                                       wx.DefaultSize, 0)
        gSizer3.Add(self.m_checkBox5, 0, wx.ALL, 5)

        self.m_checkBox6 = wx.CheckBox(self.pnChartOfAccounts, wx.ID_ANY, _("Expense Accounts"), wx.DefaultPosition,
                                       wx.DefaultSize, 0)
        ...
        self.m_staticText27 = wx.StaticText(self.pnJournal, wx.ID_ANY, _("Description"), wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        self.m_staticText27.Wrap(-1)
        fgSizer16.Add(self.m_staticText27, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_BOTTOM, 5)

        self.m_staticText28 = wx.StaticText(self.pnJournal, wx.ID_ANY, _("Debit"), wx.DefaultPosition, wx.DefaultSize,
                                            0)
        self.m_staticText28.Wrap(-1)
        fgSizer16.Add(self.m_staticText28, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_BOTTOM, 5)

        self.m_staticText29 = wx.StaticText(self.pnJournal, wx.ID_ANY, _("Credit"), wx.DefaultPosition, wx.DefaultSize,
                                            0)
        self.m_staticText29.Wrap(-1)
        fgSizer16.Add(self.m_staticText29, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_BOTTOM, 5)

        self.m_staticText30 = wx.StaticText(self.pnJournal, wx.ID_ANY, _("Amount"), wx.DefaultPosition, wx.DefaultSize,
                                            0)
        self.m_staticText30.Wrap(-1)
        fgSizer16.Add(self.m_staticText30, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_BOTTOM, 5)

        self.m_datePicker1 = wx.DatePickerCtrl(self.pnJournal, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition,
                                               wx.DefaultSize, wx.DP_DEFAULT)
        fgSizer16.Add(self.m_datePicker1, 0, wx.ALL, 5)

        self.m_textCtrl11 = wx.TextCtrl(self.pnJournal, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                        0)
        fgSizer16.Add(self.m_textCtrl11, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.m_textCtrl12 = wx.TextCtrl(self.pnJournal, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                        0)
        ...
        self.m_textCtrl13 = wx.TextCtrl(self.pnJournal, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                        0)
...
class dlgConnection(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=_("Connection to Oasys server"), pos=wx.DefaultPosition,
        ...
        self.cmbConnectionChoice = wx.ComboBox(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                               cmbConnectionChoiceChoices, 0)
...
class dlgConnectionManager(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=_("Managing Connections"), pos=wx.DefaultPosition,
                           size=wx.Size(-1, -1), style=wx.DEFAULT_DIALOG_STYLE)
        ...
        self.listboxConnections = wx.ListBox(self, wx.ID_ANY, wx.DefaultPosition, wx.Size(150, 300),
                                             listboxConnectionsChoices, wx.LB_ALWAYS_SB | wx.LB_SINGLE | wx.LB_SORT)
        ...
        self.lblConnectionName = wx.StaticText(self, wx.ID_ANY, _("Connection name"), wx.DefaultPosition,
                                               wx.DefaultSize, 0)
        ...
        self.lblConnectionUser = wx.StaticText(self, wx.ID_ANY, _("User identifier"), wx.DefaultPosition,
                                               wx.DefaultSize, 0)
        ...
        self.lblConnectionServer = wx.StaticText(self, wx.ID_ANY, _("Server name"), wx.DefaultPosition, wx.DefaultSize,
                                                 0)
        self.lblConnectionServer.Wrap(-1)
        gSizer1.Add(self.lblConnectionServer, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.txtConnectionServerName = wx.TextCtrl(self, wx.ID_ANY, _("localhost"), wx.DefaultPosition,
                                                   wx.Size(150, -1), 0)
        ...
        self.txtConnectionServerPath = wx.TextCtrl(self, wx.ID_ANY, _("jsonrpc"), wx.DefaultPosition, wx.Size(150, -1),
                                                   0)
        ...
        self.lblConnectionMode = wx.StaticText(self, wx.ID_ANY, _("Connection Mode"), wx.DefaultPosition,
                                               wx.DefaultSize, 0)
        ...
        self.selConnectionMode = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                           selConnectionModeChoices, 0)
        ...
        self.chkConnectionAuth = wx.CheckBox(self, wx.ID_ANY, _("Server requires authentication"), wx.DefaultPosition,
                                             wx.DefaultSize, 0)
        self.chkConnectionAuth.SetValue(True)
        bSizer18.Add(self.chkConnectionAuth, 0, wx.ALL, 5)

        self.chkConnectionDefault = wx.CheckBox(self, wx.ID_ANY, _("Use this as the default connection"),
...
class dlgAccountsImport(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=_("Importing Accounts"), pos=wx.DefaultPosition,
        ...
        self.m_staticText17 = wx.StaticText(self, wx.ID_ANY, _("Select the company to import to"), wx.DefaultPosition,
                                            wx.DefaultSize, 0)
        self.m_staticText17.Wrap(-1)
        bSizer9.Add(self.m_staticText17, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        selCompaniesImportChoices = []
        self.selCompaniesImport = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                            selCompaniesImportChoices, 0)
        ...
        self.lblImportSelect = wx.StaticText(self, wx.ID_ANY,
                                             _("Please select the type of account you would like to import"),
        ...
        self.rdAccountType = wx.RadioBox(self, wx.ID_ANY, _("Account types"), wx.DefaultPosition, wx.DefaultSize,
                                         rdAccountTypeChoices, 2, wx.RA_SPECIFY_COLS)
        ...
        self.m_staticText16 = wx.StaticText(self, wx.ID_ANY, _(
            "The accounts need to be placed in a CSV file with 3 columns:\n\n- Account Identifier\n- Account Label\n- Parent Account Identifier\n\nThe first line is reserved for headers and will be ignored."),
                                            wx.DefaultPosition, wx.DefaultSize, 0)
...
class dlgEntriesImport(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=_("Importing Journal Entries"), pos=wx.DefaultPosition,
                           size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE)
        ...
        self.selCompaniesImportEntries = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                                   selCompaniesImportEntriesChoices, 0)
        ...
        self.m_staticText16 = wx.StaticText(self, wx.ID_ANY, _(
            "The journal entries need to be placed in a CSV file with 6 columns:\n\n- Date\n- Operation# (may be left empty)\n- Description\n- Debit Account Identifier\n- Credit Account\n- Amount\n\nThe first line is reserved for headers and will be ignored."),
                                            wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.m_staticText22 = wx.StaticText(self, wx.ID_ANY, _(
            "Use the following conventions for describing a \ncustom date format:\n\n%y - Year without century as a decimal number [00,99]\n%Y - Year with century as a decimal number\n%b - Locale’s abbreviated month name\n%B - Locale’s full month name\n%m - Month as a decimal number [01,12].\n%d - Day of the month as a decimal number [01,31]\n\nExample: for describing mm/dd/yyyy enter %m/%d/%Y"),
                                            wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.lblImportEntriesDateFormat = wx.StaticText(self, wx.ID_ANY, _("Please select a format"),
                                                        wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.selImportEntriesDateFormat = wx.ComboBox(self, wx.ID_ANY, _("%m/%d/%Y"), wx.DefaultPosition,
                                                      wx.DefaultSize, selImportEntriesDateFormatChoices, wx.CB_DROPDOWN)
...
class dlgAccountingPeriods(wx.Dialog):
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=_("Defining Accounting Periods"), pos=wx.DefaultPosition,
                           size=wx.DefaultSize, style=wx.DEFAULT_DIALOG_STYLE)
