...
if __name__ == '__main__':
    ...
    print
    rpcsrv.get_internal_investments('Master')
    print
    rpcsrv.get_internal_investments('FeederA')
    print
    rpcsrv.get_internal_investments('FeederB')

    print
    'internal investors'
    print
    rpcsrv.get_internal_investors('Master')
    print
    rpcsrv.get_internal_investors('FeederA')
    print
    rpcsrv.get_internal_investors('FeederB')
