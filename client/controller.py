...
class OasysController(object):
    ...
    def do_connect(self, connection, sel_companies,
        ...
        self.load_data_for_company(company_code, tree_assets, tree_liabilities, tree_incomes, tree_expenses,
                                   grid_journal)
    ...
    def load_data_for_company(self, company_code, tree_assets, tree_liabilities, tree_incomes, tree_expenses,
                              grid_journal):
